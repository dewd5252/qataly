...
VALUES
  ('c1111111-1111-1111-1111-111111111111', 'مستر محمد علي', 'ALI2026', NOW()),
  ('c2222222-2222-2222-2222-222222222222', 'مستر أحمد حسن', 'HASSAN88', NOW())
...
-- Passages (English comprehension texts with MCQs)
